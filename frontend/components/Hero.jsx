  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Empowering Generosity: A Social Platform for
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">Meaningful Donations</span>
        </span>{" "}
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Join our community where every donation counts. Whether you're seeking
        support for a cause close to your heart or looking to make a difference
        in someone's life, our platform connects compassionate individuals with
        impactful donation opportunities. Together, let's create a world where
        kindness knows no bounds
      </p>
      <div className="mt-10 flex justify-center space-x-6">
        <ButtonLink href="/auth/register">Join to us</ButtonLink>
